...
import datetime
import bitstring
import tritech_micron.exceptions as exceptions #before: import exceptions
...
class TritechMicron(object):
    ...
    def get(self, message=None, wait=2):
        ...
        if message:
            ...
            print("Waiting for %s message", expected_name)
        ...
        while message is None or datetime.datetime.now() < end:
            ...
            except exceptions.PacketCorrupted as serialSerialException: #before: seral.SearialException
                # Keep trying.
                continue
