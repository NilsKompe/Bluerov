...
from core.rosbagrecordthread import RosbagRecordThread

#PATH = "/home/bluerov2-22/v1Bluerov/src/core/src/interface/"
PATH = __file__.replace("gui.py","") #path of gui.py without the ending "gui.py"
...
class Display(QtWidgets.QMainWindow):
    ...
    def _enable_automatic_control_checked(self):
        ...
        if self.checkBox_enable_automatic_control.isChecked():
            enable_automatic_mode = 0
