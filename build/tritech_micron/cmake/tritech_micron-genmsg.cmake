...
set(MSG_I_FLAGS "-Itritech_micron:/home/bluerov23/v3Bluerov/src/tritech_micron/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/bluerov23/v3Bluerov/src/tritech_micron/msg/TritechMicronConfig.msg" NAME_WE)
add_custom_target(_tritech_micron_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "tritech_micron" "/home/bluerov23/v3Bluerov/src/tritech_micron/msg/TritechMicronConfig.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(tritech_micron
  "/home/bluerov23/v3Bluerov/src/tritech_micron/msg/TritechMicronConfig.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/tritech_micron)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/tritech_micron\")")
  # install generated code
  install(
  ...
  string(REGEX REPLACE "([][+.*()^])" "\\\\\\1" ESCAPED_PATH "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/tritech_micron")
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/tritech_micron
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
