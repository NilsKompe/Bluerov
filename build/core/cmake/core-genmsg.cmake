...
set(MSG_I_FLAGS "-Icore:/home/bluerov23/v3Bluerov/src/core/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/bluerov23/v3Bluerov/src/core/msg/Bar30.msg" NAME_WE)
add_custom_target(_core_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "core" "/home/bluerov23/v3Bluerov/src/core/msg/Bar30.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/bluerov23/v3Bluerov/src/core/msg/Attitude.msg" NAME_WE)
add_custom_target(_core_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "core" "/home/bluerov23/v3Bluerov/src/core/msg/Attitude.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/bluerov23/v3Bluerov/src/core/msg/Set_depth.msg" NAME_WE)
add_custom_target(_core_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "core" "/home/bluerov23/v3Bluerov/src/core/msg/Set_depth.msg" ""
)

get_filename_component(_filename "/home/bluerov23/v3Bluerov/src/core/msg/Set_heading.msg" NAME_WE)
add_custom_target(_core_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "core" "/home/bluerov23/v3Bluerov/src/core/msg/Set_heading.msg" ""
)

get_filename_component(_filename "/home/bluerov23/v3Bluerov/src/core/msg/Set_velocity.msg" NAME_WE)
add_custom_target(_core_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "core" "/home/bluerov23/v3Bluerov/src/core/msg/Set_velocity.msg" ""
)

get_filename_component(_filename "/home/bluerov23/v3Bluerov/src/core/msg/Set_target.msg" NAME_WE)
add_custom_target(_core_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "core" "/home/bluerov23/v3Bluerov/src/core/msg/Set_target.msg" ""
)

get_filename_component(_filename "/home/bluerov23/v3Bluerov/src/core/msg/State.msg" NAME_WE)
add_custom_target(_core_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "core" "/home/bluerov23/v3Bluerov/src/core/msg/State.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/core)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/core\")")
  # install generated code
  install(
  ...
  string(REGEX REPLACE "([][+.*()^])" "\\\\\\1" ESCAPED_PATH "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/core")
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/core
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
